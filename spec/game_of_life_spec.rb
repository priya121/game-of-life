...
describe "game of life" do 
    ...
    it "takes a 3 game with no live cells and returns an empty world" do
        game = World.new([0,0,0,0,0,0,0,0,0],3,3)
        game.tick
        expect(game.cells).to eq([0,0,0,0,0,0,0,0,0])
    end

    it "takes a 9 cell game with one live cell and returns an empty world" do 
        game = World.new([1,0,0,0,0,0,0,0,0],3,3)
        game.tick
        expect(game.cells).to eq([0,0,0,0,0,0,0,0,0])
    end

    it "takes a 9 cell game with two live cells and returns an empty world" do
